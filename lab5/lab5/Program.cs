...
namespace Lab05
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\qdenni\OneDrive\Рабочий стол\DP\lab5\test2.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\qdenni\OneDrive\Рабочий стол\DP\lab5\test4.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\qdenni\OneDrive\Рабочий стол\DP\lab5\test12.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
                string? result = hash.Save("BBBBCCCCC");
            ...
            {
                IWriter writer = new FileWriter(@"C:\Users\qdenni\OneDrive\Рабочий стол\DP\lab5\test13.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
                string? result = hash.Save("BBBBCCCCC");
